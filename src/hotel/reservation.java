...
public class reservation extends javax.swing.JFrame {
    ...
    public void autoID() {
        try {
            ...
            ResultSet rs = s.executeQuery("SELECT MAX(ReserveNo) from reservation");
            rs.next();
            String maxID = rs.getString("MAX(ReserveNo)");

            if (rs.getString("MAX(ReserveNo)") == null) {
                jLabel12.setText("R0001");
            } else {
                long id = Long.parseLong(maxID.substring(2));
                id++;
                jLabel12.setText("R" + String.format("%04d", id));
            }
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ReserveNo", "Name", "Adress", "MobileNo", "CheckIn", "CheckOut", "RoomType", "RoomNo", "BedType", "Amount"
            }
        ) {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            pat = con.prepareStatement("insert into reservation (ReserveNO,Name,Address,MobileNo,CheckIn,CheckOut,bedType,roomNo,roomType,amount) values (?,?,?,?,?,?,?,?,?,?)");
            pat.setString(1, reserveID);
            pat.setString(2, name);
            pat.setString(3, address);
            pat.setString(4, mobile);
            pat.setString(5, StartDate);
            pat.setString(6, EndDate);
            pat.setString(7, bedType);
            pat.setString(8, roomNo);
            pat.setString(9, roomType);
            pat.setString(10, amount);
    ...
    SimpleDateFormat df1 = new SimpleDateFormat("yyyy-MM-dd");
    String StartDate = txtcheckin.getDate() != null ? df1.format(txtcheckin.getDate()) : null;
    String EndDate = txtcheckout.getDate() != null ? df1.format(txtcheckout.getDate()) : null;
    ...
    try {
        ...
        pat = con.prepareStatement("SELECT COUNT(*) FROM reservation WHERE roomNo = ? AND ((CheckIn BETWEEN ? AND ?) OR (CheckOut BETWEEN ? AND ?))");
        ...
        // If no issues, update the reservation in the database
        pat = con.prepareStatement("UPDATE reservation SET Name = ?, Address = ?, MobileNo = ?, CheckIn = ?, CheckOut = ?, bedType = ?, roomNo = ?, roomType = ?, amount = ? WHERE ReserveNo = ?");
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        if (selectedRow >= 0) { // Ensure a valid row is selected
            try {
                ...
                txtamount.setText(jTable1.getValueAt(selectedRow, 9) != null ? jTable1.getValueAt(selectedRow, 9).toString() : "");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try {
            pat = con.prepareStatement("DELETE FROM reservation where ReserveNo = ? ");
